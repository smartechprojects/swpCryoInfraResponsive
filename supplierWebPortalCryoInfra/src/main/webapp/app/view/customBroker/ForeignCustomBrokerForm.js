Ext.define('SupplierApp.view.customBroker.ForeignCustomBrokerForm', {
	extend : 'Ext.form.Panel',
	alias : 'widget.foreignCustomBrokerForm',
	border : false,
	frame : false,
	...
	initComponent : function() {
		...
		this.items = [{
			...
			items : [{
		        ...
		        items:[{
							...
							name : 'name',
							width : 460,
							readOnly: role=='ROLE_SUPPLIER' || role=='ROLE_PURCHASE' || role=='ROLE_ADMIN'?false:true,
							...
							id : 'foreignCompanyComboCB',
							itemId : 'foreignCompanyComboCB',
							name : 'foreignCompany',
							...
							itemId : 'foreignSubtotalCB',
							id : 'foreignSubtotalCB',
							labelWidth:120,
		            		...
		            		listeners:{
								change: function(field, newValue, oldValue){
									...
									var tax = Ext.getCmp('foreignTaxesCB').getValue();
									var retention = Ext.getCmp('foreignRetentionCB').getValue();
									var total = newValue + tax - retention;
									
									Ext.getCmp('foreignDebitCB').setValue(total);
		            		...
		            		listeners:{
								change: function(field, newValue, oldValue){
									...
									var subTotal = Ext.getCmp('foreignSubtotalCB').getValue();
									var retention = Ext.getCmp('foreignRetentionCB').getValue();
							...
							itemId : 'foreignRetentionCB',
							id : 'foreignRetentionCB',
							labelWidth:120,
						...
						},
						{
							...
							xtype: 'numericfield',
							name : 'advancePayment',
							itemId : 'advancePaymentForeignCB',
							id : 'advancePaymentForeignCB',				    			    									
		...
		this.tbar = [{
			...
			itemId : 'sendForeignRecordCB',
			id : 'sendForeignRecordCB',			
			action : 'sendForeignRecordCB'
		},'-',{
			iconCls:'icon-document',
			text: SuppAppMsg.purchaseTitle25,
			action : 'uploadForeignDocsCB',
			itemId: 'uploadForeignDocsCB',
