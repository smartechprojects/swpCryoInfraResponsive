...
Ext.define('SupplierApp.view.taxVault.TaxVaultWorkerFileGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.taxVaultWorkerFileGrid',
    loadMask: true,
	frame:false,
	border:false,
...
//		}
	...
	buttons : [ {
		...
		handler : function() {
			...
			if (form.isValid()) {
				form.submit({
							url : 'taxVault/uploadFileWorker.action?idworker='+recordWorker.id,
