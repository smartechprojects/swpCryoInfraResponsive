...
public class VoucherHeaderDTO
{
	...
	public String getSYDCTV() {
		return SYDCTV;
	}
	public void setSYDCTV(String sYDCTV) {
		SYDCTV = sYDCTV;
	}
	...
	public String getSYUPMJ() {
		return SYUPMJ;
	}
	public void setSYUPMJ(String sYUPMJ) {
		SYUPMJ = sYUPMJ;
	}
	public String getSYRMK() {
		return SYRMK;
	}
	public void setSYRMK(String sYRMK) {
		SYRMK = sYRMK;
	}
	@Override
	public String toString() {
		return "VoucherHeaderDTO [SYEDTY=" + SYEDTY + ", SYEDSQ=" + SYEDSQ + ", SYEKCO=" + SYEKCO + ", SYEDOC=" + SYEDOC
				+ ", SYEDCT=" + SYEDCT + ", SYEDLN=" + SYEDLN + ", SYEDST=" + SYEDST + ", SYEDER=" + SYEDER
				+ ", SYKCOO=" + SYKCOO + ", SYDOCO=" + SYDOCO + ", SYDCTO=" + SYDCTO + ", SYSFXO=" + SYSFXO
				+ ", SYVR01=" + SYVR01 + ", SYURRF=" + SYURRF + ", SYAN8=" + SYAN8 + ", SYDGJ=" + SYDGJ + ", SYDIVJ="
				+ SYDIVJ + ", SYVINV=" + SYVINV + ", SYSHAN=" + SYSHAN + ", SYMCU=" + SYMCU + ", TORG=" + TORG
				+ ", USER=" + USER + ", PID=" + PID + ", JOBN=" + JOBN + ", UPMJ=" + UPMJ + ", TDAY=" + TDAY + ", CRRM="
				+ CRRM + ", SYCRCD=" + SYCRCD + ", SYCRR=" + SYCRR + ", SYDDU=" + SYDDU + ", SYDDJ=" + SYDDJ
				+ ", SYDCTV=" + SYDCTV + ", SYEDBT=" + SYEDBT + ", voucherDetailDTO=" + voucherDetailDTO
				+ ", voucherSummaryDTO=" + voucherSummaryDTO + "]";
	}
